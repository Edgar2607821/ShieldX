...
import os
SHIELDX_ENV_FILE = os.getenv("SHIELDX_ENV_FILE", ".env")
if os.path.exists(SHIELDX_ENV_FILE):
  load_dotenv(SHIELDX_ENV_FILE)
...
SHIELDX_CORS_ORIGINS           = os.environ.get("SHIELDX_CORS_ORIGINS", "*").split(",")
SHIELDX_CORS_ALLOW_CREDENTIALS = bool(int(os.environ.get("SHIELDX_CORS_ALLOW_CREDENTIALS", "1")))
# ========================
# Conexión a Base de Datos
# ========================
SHIELDX_MONGODB_URI         = os.environ.get("SHIELDX_MONGODB_URI", "mongodb://localhost:27017/shieldx")
print("MongoDB URI:", SHIELDX_MONGODB_URI)
